...
TERMS_FILE = DOCS_DIR / "TERMS.md"
PRIVACY_FILE = DOCS_DIR / "PRIVACY.md"
...
MUSIC_QUEUE_STATE_FILE = APP_STORAGE_DIR / "music_queue_state.json"
...
AUTH_STATE_FILE = APP_STORAGE_DIR / "twitch_auth_state.json"
LOGS_DIR = APP_STORAGE_DIR / "logs"
TELEMETRY_LOG_FILE = LOGS_DIR / "telemetry.log"
DIAGNOSTICS_LOG_FILE = LOGS_DIR / "diagnostics.log"
CRASH_REPORT_STATE_FILE = APP_STORAGE_DIR / "crash_report_state.json"
TELEMETRY_FILE = APP_STORAGE_DIR / "telemetry.json"
BOT_TOKEN_FILE = APP_STORAGE_DIR / "twitch_bot_auth.json"
CHANNEL_TOKEN_FILE = APP_STORAGE_DIR / "twitch_channel_auth.json"
BOT_SECURE_TOKEN_FILE = APP_STORAGE_DIR / "twitch_bot_auth.dpapi"
CHANNEL_SECURE_TOKEN_FILE = APP_STORAGE_DIR / "twitch_channel_auth.dpapi"
